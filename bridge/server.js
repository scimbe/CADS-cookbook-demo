...
const listenAddr = process.env.COOKBOOK_BRIDGE_LISTEN || "0.0.0.0:8789";
...
server.listen(port, host || "0.0.0.0", () => {
  process.stderr.write(`cookbook-crew-bridge: serving POST /cookbook/build on ${host || "0.0.0.0"}:${port}\n`);
});
