...
COOKBOOK_JOIN_TOKEN="$TOKEN" \
COOKBOOK_AGENT_TOKEN="$COOKBOOK_AGENT_TOKEN" \
COOKBOOK_AGENT_EDGE="$EDGE" \
COOKBOOK_AGENT_CP_URL="$CP_URL" \
COOKBOOK_AGENT_EDGE_CERT_URL="${COOKBOOK_AGENT_EDGE_CERT_URL:-$CP_URL/pki/ca}" \
  $COMPOSE up --build -d
